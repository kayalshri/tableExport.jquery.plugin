...
b.currentStyle?b.currentStyle[a]:b.style[a]}catch(e){}return""}function fa(b,a,e){a=L(b,a).match(/\d+/);if(null!==a){a=a[0];b=b.parentElement;var c=document.createElement("div");c.style.overflow="hidden";c.style.visibility="hidden";b.appendChild(c);c.style.width=100+e;e=100/c.offsetWidth;b.removeChild(c);return a*e}return 0}function Oa(a){for(var b=new ArrayBuffer(a.length),e=new Uint8Array(b),d=0;d!==a.length;++d)e[d]=a.charCodeAt(d)&255;return b}function na(a){var b=a.c,e="";for(++b;b;b=Math.floor((b-
1)/26))e=String.fromCharCode((b-1)%26+65)+e;return e+(""+(a.r+1))}function oa(a,c){if("undefined"===typeof c||"number"===typeof c)return oa(a.s,a.e);"string"!==typeof a&&(a=na(a));"string"!==typeof c&&(c=na(c));return a===c?a:a+":"+c}function Da(a,c){var b=Number(a);if(!isNaN(b))return b;var d=1;""!==c.thousandsSeparator&&(a=a.replace(new RegExp("([\\d])"+c.thousandsSeparator+"([\\d])","g"),"$1$2"));"."!==c.decimalMark&&(a=a.replace(new RegExp("([\\d])"+c.decimalMark+"([\\d])","g"),"$1.$2"));a=a.replace(/[$]/g,
"").replace(/[%]/g,function(){d*=100;return""});if(!isNaN(b=Number(a)))return b/d;a=a.replace(/[(](.*)[)]/,function(a,b){d=-d;return b});return isNaN(b=Number(a))?b:b/d}function ya(a){var b=0,d;if(0===a.length)return b;var q=0;for(d=a.length;q<d;q++){var f=a.charCodeAt(q);b=(b<<5)-b+f;b|=0}return b}function M(b,c,d,q,f,m){var e=!0;"function"===typeof a.onBeforeSaveToFile&&(e=a.onBeforeSaveToFile(b,c,d,q,f),"boolean"!==typeof e&&(e=!0));if(e)try{if(Ea=new Blob([b],{type:d+";charset="+q}),saveAs(Ea,
c,!1===m),"function"===typeof a.onAfterSaveToFile)a.onAfterSaveToFile(b,c)}catch(k){ja(c,"data:"+d+(q.length?";charset="+q:"")+(f.length?";"+f:"")+",",m?"\ufeff"+b:b)}}function ja(b,c,d){var e=window.navigator.userAgent;if(!1!==b&&window.navigator.msSaveOrOpenBlob)window.navigator.msSaveOrOpenBlob(new Blob([d]),b);else if(!1!==b&&(0<e.indexOf("MSIE ")||e.match(/Trident.*rv\:11\./))){if(c=document.createElement("iframe")){document.body.appendChild(c);c.setAttribute("style","display:none");c.contentDocument.open("txt/plain",
"replace");c.contentDocument.write(d);c.contentDocument.close();c.contentWindow.focus();switch(b.substr(b.lastIndexOf(".")+1)){case "doc":case "json":case "png":case "pdf":case "xls":case "xlsx":b+=".txt"}c.contentDocument.execCommand("SaveAs",!0,b);document.body.removeChild(c)}}else{var f=document.createElement("a");if(f){var m=null;f.style.display="none";!1!==b?f.download=b:f.target="_blank";"object"===typeof d?(window.URL=window.URL||window.webkitURL,e=[],e.push(d),m=window.URL.createObjectURL(new Blob(e,
{type:c})),f.href=m):0<=c.toLowerCase().indexOf("base64,")?f.href=c+K(d):f.href=c+encodeURIComponent(d);document.body.appendChild(f);if(document.createEvent)null===ha&&(ha=document.createEvent("MouseEvents")),ha.initEvent("click",!0,!1),f.dispatchEvent(ha);else if(document.createEventObject)f.fireEvent("onclick");else if("function"===typeof f.onclick)f.onclick();setTimeout(function(){m&&window.URL.revokeObjectURL(m);document.body.removeChild(f);if("function"===typeof a.onAfterSaveToFile)a.onAfterSaveToFile(d,
b)},100)}}}function K(a){var b,d="",q=0;if("string"===typeof a){a=a.replace(/\x0d\x0a/g,"\n");var f="";for(b=0;b<a.length;b++){var m=a.charCodeAt(b);128>m?f+=String.fromCharCode(m):(127<m&&2048>m?f+=String.fromCharCode(m>>6|192):(f+=String.fromCharCode(m>>12|224),f+=String.fromCharCode(m>>6&63|128)),f+=String.fromCharCode(m&63|128))}a=f}for(;q<a.length;){var t=a.charCodeAt(q++);f=a.charCodeAt(q++);b=a.charCodeAt(q++);m=t>>2;t=(t&3)<<4|f>>4;var k=(f&15)<<2|b>>6;var g=b&63;isNaN(f)?k=g=64:isNaN(b)&&
(g=64);d=d+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(m)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(t)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g)}return d}var a={csvEnclosure:'"',csvSeparator:",",csvUseBOM:!0,date:{html:"dd/mm/yyyy"},displayTableName:!1,escape:!1,exportHiddenCells:!1,fileName:"tableExport",htmlContent:!1,htmlHyperlink:"content",
...
h+(1<h?1:0);h=(0<=v.indexOf("yyyy")?v.indexOf("yyyy"):v.indexOf("yy"))+1;a.date.match_y=h+(1<h?1:0)}T=S(A);if("csv"===a.type||"tsv"===a.type||"txt"===a.type){var P="",Z=0;G=[];p=0;var pa=function(b,c,e){b.each(function(){n="";E(this,c,p,e+b.length,function(b,c,d){var e=n,f="";if(null!==b)if(b=F(b,c,d),c=null===b||""===b?"":b.toString(),"tsv"===a.type)b instanceof Date&&b.toLocaleString(),f=W(c,"\t"," ");else if(b instanceof Date)f=a.csvEnclosure+b.toLocaleString()+a.csvEnclosure;else if(f=Ba(c),f=
W(f,a.csvEnclosure,a.csvEnclosure+a.csvEnclosure),0<=f.indexOf(a.csvSeparator)||/[\r\n ]/g.test(f))f=a.csvEnclosure+f+a.csvEnclosure;n=e+(f+("tsv"===a.type?"\t":a.csvSeparator))});n=d.trim(n).substring(0,n.length-1);0<n.length&&(0<P.length&&(P+="\n"),P+=n);p++});return b.length};Z+=pa(d(A).find("thead").first().find(a.theadSelector),"th,td",Z);C(d(A),"tbody").each(function(){Z+=pa(C(d(this),a.tbodySelector),"td,th",Z)});a.tfootSelector.length&&pa(d(A).find("tfoot").first().find(a.tfootSelector),"td,th",
Z);P+="\n";if("string"===a.outputMode)return P;if("base64"===a.outputMode)return K(P);if("window"===a.outputMode){ja(!1,"data:text/"+("csv"===a.type?"csv":"plain")+";charset=utf-8,",P);return}M(P,a.fileName+"."+a.type,"text/"+("csv"===a.type?"csv":"plain"),"utf-8","","csv"===a.type&&a.csvUseBOM)}else if("sql"===a.type){p=0;G=[];var w="INSERT INTO "+a.sql.tableEnclosure+a.tableName+a.sql.tableEnclosure+" (";u=y(d(A));d(u).each(function(){E(this,"th,td",p,u.length,function(b,c,d){b=F(b,c,d)||"";-1<
b.indexOf(a.sql.columnEnclosure)&&(b=W(b.toString(),a.sql.columnEnclosure,a.sql.columnEnclosure+a.sql.columnEnclosure));w+=a.sql.columnEnclosure+b+a.sql.columnEnclosure+","});p++;w=d.trim(w).substring(0,w.length-1)});w+=") VALUES ";r=B(d(A));d(r).each(function(){n="";E(this,"td,th",p,u.length+r.length,function(a,c,d){a=F(a,c,d)||"";-1<a.indexOf("'")&&(a=W(a.toString(),"'","''"));n+="'"+a+"',"});3<n.length&&(w+="("+n,w=d.trim(w).substring(0,w.length-1),w+="),");p++});w=d.trim(w).substring(0,w.length-
1);w+=";";if("string"===a.outputMode)return w;if("base64"===a.outputMode)return K(w);M(w,a.fileName+".sql","application/sql","utf-8","",!1)}else if("json"===a.type){var X=[];G=[];u=y(d(A));d(u).each(function(){var a=[];E(this,"th,td",p,u.length,function(b,d,g){a.push(F(b,d,g))});X.push(a)});var qa=[];r=B(d(A));d(r).each(function(){var a={},c=0;E(this,"td,th",p,u.length+r.length,function(b,d,f){X.length?a[X[X.length-1][c]]=F(b,d,f):a[c]=F(b,d,f);c++});!1===d.isEmptyObject(a)&&qa.push(a);p++});h="";
h="head"===a.jsonScope?JSON.stringify(X):"data"===a.jsonScope?JSON.stringify(qa):JSON.stringify({header:X,data:qa});if("string"===a.outputMode)return h;if("base64"===a.outputMode)return K(h);M(h,a.fileName+".json","application/json","utf-8","base64",!1)}else if("xml"===a.type){p=0;G=[];var Q='<?xml version="1.0" encoding="utf-8"?>';Q+="<tabledata><fields>";u=y(d(A));d(u).each(function(){E(this,"th,td",p,u.length,function(a,d,e){Q+="<field>"+F(a,d,e)+"</field>"});p++});Q+="</fields><data>";var ra=
1;r=B(d(A));d(r).each(function(){var a=1;n="";E(this,"td,th",p,u.length+r.length,function(b,d,g){n+="<column-"+a+">"+F(b,d,g)+"</column-"+a+">";a++});0<n.length&&"<column-1></column-1>"!==n&&(Q+='<row id="'+ra+'">'+n+"</row>",ra++);p++});Q+="</data></tabledata>";if("string"===a.outputMode)return Q;if("base64"===a.outputMode)return K(Q);M(Q,a.fileName+".xml","application/xml","utf-8","base64",!1)}else if("excel"===a.type&&"xmlss"===a.mso.fileFormat){var sa=[],D=[];d(A).filter(function(){return I(d(this))}).each(function(){function b(a,
b,c){var f=[];d(a).each(function(){var b=0,e=0;n="";E(this,"td,th",p,c+a.length,function(a,c,m){if(null!==a){var k="";c=F(a,c,m);m="String";if(!1!==jQuery.isNumeric(c))m="Number";else{var g=Ma(c);!1!==g&&(c=g,m="Number",k+=' ss:StyleID="pct1"')}"Number"!==m&&(c=c.replace(/\n/g,"<br>"));g=O(a);a=U(a);d.each(f,function(){if(p>=this.s.r&&p<=this.e.r&&e>=this.s.c&&e<=this.e.c)for(var a=0;a<=this.e.c-this.s.c;++a)e++,b++});if(a||g)a=a||1,g=g||1,f.push({s:{r:p,c:e},e:{r:p+a-1,c:e+g-1}});1<g&&(k+=' ss:MergeAcross="'+
(g-1)+'"',e+=g-1);1<a&&(k+=' ss:MergeDown="'+(a-1)+'" ss:StyleID="rsp1"');0<b&&(k+=' ss:Index="'+(e+1)+'"',b=0);n+="<Cell"+k+'><Data ss:Type="'+m+'">'+d("<div />").text(c).html()+"</Data></Cell>\r";e++}});0<n.length&&(H+='<Row ss:AutoFitHeight="0">\r'+n+"</Row>\r");p++});return a.length}var c=d(this),e="";"string"===typeof a.mso.worksheetName&&a.mso.worksheetName.length?e=a.mso.worksheetName+" "+(D.length+1):"undefined"!==typeof a.mso.worksheetName[D.length]&&(e=a.mso.worksheetName[D.length]);e.length||
(e=c.find("caption").text()||"");e.length||(e="Table "+(D.length+1));e=d.trim(e.replace(/[\\\/[\]*:?'"]/g,"").substring(0,31));D.push(d("<div />").text(e).html());!1===a.exportHiddenCells&&(J=c.find("tr, th, td").filter(":hidden"),V=0<J.length);p=0;T=S(this);H="<Table>\r";e=b(y(c),"th,td",0);b(B(c),"td,th",e);H+="</Table>\r";sa.push(H)});h={};v={};for(var l,R,Y=0,da=D.length;Y<da;Y++)l=D[Y],R=h[l],R=h[l]=null==R?1:R+1,2===R&&(D[v[l]]=D[v[l]].substring(0,29)+"-1"),1<h[l]?D[Y]=D[Y].substring(0,29)+
"-"+h[l]:v[l]=Y;h='<?xml version="1.0" encoding="UTF-8"?>\r<?mso-application progid="Excel.Sheet"?>\r<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"\r xmlns:o="urn:schemas-microsoft-com:office:office"\r xmlns:x="urn:schemas-microsoft-com:office:excel"\r xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet"\r xmlns:html="http://www.w3.org/TR/REC-html40">\r<DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">\r  <Created>'+(new Date).toISOString()+'</Created>\r</DocumentProperties>\r<OfficeDocumentSettings xmlns="urn:schemas-microsoft-com:office:office">\r  <AllowPNG/>\r</OfficeDocumentSettings>\r<ExcelWorkbook xmlns="urn:schemas-microsoft-com:office:excel">\r  <WindowHeight>9000</WindowHeight>\r  <WindowWidth>13860</WindowWidth>\r  <WindowTopX>0</WindowTopX>\r  <WindowTopY>0</WindowTopY>\r  <ProtectStructure>False</ProtectStructure>\r  <ProtectWindows>False</ProtectWindows>\r</ExcelWorkbook>\r<Styles>\r  <Style ss:ID="Default" ss:Name="Normal">\r    <Alignment ss:Vertical="Bottom"/>\r    <Borders/>\r    <Font/>\r    <Interior/>\r    <NumberFormat/>\r    <Protection/>\r  </Style>\r  <Style ss:ID="rsp1">\r    <Alignment ss:Vertical="Center"/>\r  </Style>\r  <Style ss:ID="pct1">\r    <NumberFormat ss:Format="Percent"/>\r  </Style>\r</Styles>\r';
...
m:"",w={f:'=HYPERLINK("'+d(r).find("a").attr("href")+(m.length?'","'+m:"")+'")'};else if("n"===D||!isNaN(Da(m,a.numbers.output)))r=Da(m,a.numbers.output),0===x&&"function"!==typeof a.mso.xslx.formatId.numbers&&(x=a.mso.xslx.formatId.numbers),isNaN(r)&&isNaN(m)||(w={t:"n",v:isNaN(r)?m:r,z:"string"===typeof x?x:x in y?y[x]:"0.00"});else if(!1!==(r=La(m))||"d"===D)0===x&&"function"!==typeof a.mso.xslx.formatId.date&&(x=a.mso.xslx.formatId.date),w={t:"d",v:!1!==r?r:m,z:"string"===typeof x?x:x in y?y[x]:
"m/d/yy"};c[na({c:n,r:h})]=w;g.e.c<n&&(g.e.c=n);n+=v}++h}f.length&&(c["!merges"]=f);t.length&&(c["!rows"]=t);g.e.r=h-1;c["!ref"]=oa(g);1E7<=h&&(c["!fullref"]=oa((g.e.r=e.length-k+h-1,g)));e="";"string"===typeof a.mso.worksheetName&&a.mso.worksheetName.length?e=a.mso.worksheetName+" "+(aa.length+1):"undefined"!==typeof a.mso.worksheetName[aa.length]&&(e=a.mso.worksheetName[aa.length]);e.length||(e=b.find("caption").text()||"");e.length||(e="Table "+(aa.length+1));e=d.trim(e.replace(/[\\\/[\]*:?'"]/g,
