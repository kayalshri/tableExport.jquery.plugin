...
function S(b){var c=[];d(b).find("thead").first().find("th").each(function(b,a){void 0!==d(a).attr("data-field")?c[b]=d(a).attr("data-field"):c[b]=b.toString()});return c}function I(b){var c="undefined"!==typeof b[0].rowIndex,a=!1===c&&"undefined"!==typeof b[0].cellIndex,p=a||c?Ka(b):b.is(":visible"),f=b.attr("data-tableexport-display");a&&"none"!==f&&"always"!==f&&(b=d(b[0].parentNode),c="undefined"!==typeof b[0].rowIndex,f=b.attr("data-tableexport-display"));c&&"none"!==f&&"always"!==f&&(f=b.closest("table").attr("data-tableexport-display"));
...
Q+="</data></tabledata>";if("string"===a.outputMode)return Q;if("base64"===a.outputMode)return K(Q);M(Q,a.fileName+".xml","application/xml","utf-8","base64",!1)}else if("excel"===a.type&&"xmlss"===a.mso.fileFormat){var sa=[],F=[];d(v).filter(function(){return I(d(this))}).each(function(){function b(a,b,c){var f=[];d(a).each(function(){var b=0,e=0;r="";E(this,"td,th",q,c+a.length,function(a,c,m){if(null!==a){var k="";c=D(a,c,m);m="String";if(!1!==jQuery.isNumeric(c))m="Number";else{var g=Ma(c);!1!==
g&&(c=g,m="Number",k+=' ss:StyleID="pct1"')}"Number"!==m&&(c=c.replace(/\n/g,"<br>"));g=O(a);a=U(a);d.each(f,function(){if(q>=this.s.r&&q<=this.e.r&&e>=this.s.c&&e<=this.e.c)for(var a=0;a<=this.e.c-this.s.c;++a)e++,b++});if(a||g)a=a||1,g=g||1,f.push({s:{r:q,c:e},e:{r:q+a-1,c:e+g-1}});1<g&&(k+=' ss:MergeAcross="'+(g-1)+'"',e+=g-1);1<a&&(k+=' ss:MergeDown="'+(a-1)+'" ss:StyleID="rsp1"');0<b&&(k+=' ss:Index="'+(e+1)+'"',b=0);r+="<Cell"+k+'><Data ss:Type="'+m+'">'+d("<div />").text(c).html()+"</Data></Cell>\r";
...
if("string"===a.outputMode)return l;if("base64"===a.outputMode)return K(l);M(l,a.fileName+"."+A,"application/vnd.ms-"+h,"","base64",!1)}else if("png"===a.type)html2canvas(d(v)[0]).then(function(b){b=b.toDataURL();for(var c=atob(b.substring(22)),d=new ArrayBuffer(c.length),g=new Uint8Array(d),f=0;f<c.length;f++)g[f]=c.charCodeAt(f);if("string"===a.outputMode)return c;if("base64"===a.outputMode)return K(b);"window"===a.outputMode?window.open(b):M(d,a.fileName+".png","image/png","","",!1)});else if("pdf"===
a.type)if(!0===a.pdfmake.enabled){h=[];var Ha=[];q=0;G=[];A=function(a,c,e){var b=0;d(a).each(function(){var a=[];E(this,c,q,e,function(b,c,d){if("undefined"!==typeof b&&null!==b){var e=O(b),f=U(b);b=D(b,c,d)||" ";1<e||1<f?a.push({colSpan:e||1,rowSpan:f||1,text:b}):a.push(b)}else a.push(" ")});a.length&&Ha.push(a);b<a.length&&(b=a.length);q++});return b};t=y(d(this));l=A(t,"th,td",t.length);for(R=h.length;R<l;R++)h.push("*");w=B(d(this));A(w,"th,td",t.length+w.length);h={content:[{table:{headerRows:t.length,
...
za(a,c.elements,g),a.textPos.y=b,Aa(a,c.elements,g)):Aa(a,{},g));else{c=c.elements[0];var e=d(c).attr("data-tableexport-canvas"),f=c.getBoundingClientRect();a.width=f.width*g.wScaleFactor;a.height=f.height*g.hScaleFactor;b.row.height=a.height;ua(a,c,e,g)}return!1});g.headerrows=[];t=y(d(this));d(t).each(function(){b=0;g.headerrows[q]=[];E(this,"th,td",q,t.length,function(a,c,d){var e=Da(a);e.title=D(a,c,d);e.key=b++;e.rowIndex=q;g.headerrows[q].push(e)});q++});if(0<q)for(var e=q-1;0<=e;)d.each(g.headerrows[e],
