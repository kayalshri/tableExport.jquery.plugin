...
(f+=a.excelstyles[e]+": "+d(this).css(a.excelstyles[e])+";");f+="'>"+p(b,c,h)+"</td>"});h++;f+="</tr>"});v=1;d(this).find("tbody").find(a.tbodySelector).each(function(){f+="<tr>";n(this,"td",h,function(b,c,h){f+="<td style='";for(var e in a.excelstyles)a.excelstyles.hasOwnProperty(e)&&(f+=a.excelstyles[e]+": "+d(this).css(a.excelstyles[e])+";");d(this).is("[colspan]")&&(f+="' colspan='"+d(this).attr("colspan"));f+="'>"+p(b,c,h)+"</td>"});v++;h++;f+="</tr>"});a.displayTableName&&(f+="<tr><td></td></tr><tr><td></td></tr><tr><td>"+
