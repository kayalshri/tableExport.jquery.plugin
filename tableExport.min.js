...
function(b,a){0<b&&(d+="\n");d+=c.trim(a).replace(/\u00AD/g,"")});if("json"==a.type||!1===a.numbers.output)b=fa(d),!1!==b&&(d=Number(b));else if(a.numbers.html.decimalMark!=a.numbers.output.decimalMark||a.numbers.html.thousandsSeparator!=a.numbers.output.thousandsSeparator)if(b=fa(d),!1!==b){var m=(""+b).split(".");1==m.length&&(m[1]="");var f=3<m[0].length?m[0].length%3:0,d=(0>b?"-":"")+(a.numbers.output.thousandsSeparator?(f?m[0].substr(0,f)+a.numbers.output.thousandsSeparator:"")+m[0].substr(f).replace(/(\d{3})(?=\d)/g,
"$1"+a.numbers.output.thousandsSeparator):m[0])+(m[1].length?a.numbers.output.decimalMark+m[1]:"")}}!0===a.escape&&(d=escape(d));"function"===typeof a.onCellData&&(d=a.onCellData(w,k,e,d))}return d}function la(b,a,e){return a+"-"+e.toLowerCase()}function N(b,a){var k=/^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/.exec(b),d=a;k&&(d=[parseInt(k[1]),parseInt(k[2]),parseInt(k[3])]);return d}function ga(b){var a=E(b,"text-align"),e=E(b,"font-weight"),d=E(b,"font-style"),w="";"start"==a&&(a="rtl"==E(b,
"direction")?"right":"left");700<=e&&(w="bold");"italic"==d&&(w+=d);""===w&&(w="normal");a={style:{align:a,bcolor:N(E(b,"background-color"),[255,255,255]),color:N(E(b,"color"),[0,0,0]),fstyle:w},colspan:parseInt(c(b).attr("colspan"))||0,rowspan:parseInt(c(b).attr("rowspan"))||0};null!==b&&(b=b.getBoundingClientRect(),a.rect={width:b.width,height:b.height});return a}function E(b,a){try{return window.getComputedStyle?(a=a.replace(/([a-z])([A-Z])/,la),window.getComputedStyle(b,null).getPropertyValue(a)):
b.currentStyle?b.currentStyle[a]:b.style[a]}catch(e){}return""}function O(b,a,e){a=E(b,a).match(/\d+/);if(null!==a){a=a[0];b=b.parentElement;var d=document.createElement("div");d.style.overflow="hidden";d.style.visibility="hidden";b.appendChild(d);d.style.width=100+e;e=100/d.offsetWidth;b.removeChild(d);return a*e}return 0}function T(){if(!(this instanceof T))return new T;this.SheetNames=[];this.Sheets={}}function ma(a){for(var b=new ArrayBuffer(a.length),e=new Uint8Array(b),d=0;d!=a.length;++d)e[d]=
a.charCodeAt(d)&255;return b}function na(a){for(var b={},e={s:{c:1E7,r:1E7},e:{c:0,r:0}},d=0;d!=a.length;++d)for(var c=0;c!=a[d].length;++c){e.s.r>d&&(e.s.r=d);e.s.c>c&&(e.s.c=c);e.e.r<d&&(e.e.r=d);e.e.c<c&&(e.e.c=c);var g={v:a[d][c]};if(null!==g.v){var t=XLSX.utils.encode_cell({c:c,r:d});if("number"===typeof g.v)g.t="n";else if("boolean"===typeof g.v)g.t="b";else if(g.v instanceof Date){g.t="n";g.z=XLSX.SSF._table[14];var m=g,f;f=(Date.parse(g.v)-new Date(Date.UTC(1899,11,30)))/864E5;m.v=f}else g.t=
"s";b[t]=g}}1E7>e.s.c&&(b["!ref"]=XLSX.utils.encode_range(e));return b}function da(a){var b=0,c,d,f;if(0===a.length)return b;c=0;for(f=a.length;c<f;c++)d=a.charCodeAt(c),b=(b<<5)-b+d,b|=0;return b}function C(a,c,e){var b=window.navigator.userAgent;if(!1!==a&&(0<b.indexOf("MSIE ")||b.match(/Trident.*rv\:11\./)))if(window.navigator.msSaveOrOpenBlob)window.navigator.msSaveOrOpenBlob(new Blob([e]),a);else{if(c=document.createElement("iframe"))document.body.appendChild(c),c.setAttribute("style","display:none"),
c.contentDocument.open("txt/html","replace"),c.contentDocument.write(e),c.contentDocument.close(),c.focus(),c.contentDocument.execCommand("SaveAs",!0,a),document.body.removeChild(c)}else if(b=document.createElement("a")){b.style.display="none";!1!==a?b.download=a:b.target="_blank";0<=c.toLowerCase().indexOf("base64,")?b.href=c+F(e):b.href=c+encodeURIComponent(e);document.body.appendChild(b);if(document.createEvent)null===Q&&(Q=document.createEvent("MouseEvents")),Q.initEvent("click",!0,!1),b.dispatchEvent(Q);
else if(document.createEventObject)b.fireEvent("onclick");else if("function"==typeof b.onclick)b.onclick();document.body.removeChild(b)}}function F(a){var b="",c,d,f,g,t,m,h=0;a=a.replace(/\x0d\x0a/g,"\n");d="";for(f=0;f<a.length;f++)g=a.charCodeAt(f),128>g?d+=String.fromCharCode(g):(127<g&&2048>g?d+=String.fromCharCode(g>>6|192):(d+=String.fromCharCode(g>>12|224),d+=String.fromCharCode(g>>6&63|128)),d+=String.fromCharCode(g&63|128));for(a=d;h<a.length;)c=a.charCodeAt(h++),d=a.charCodeAt(h++),f=a.charCodeAt(h++),
...
excelstyles:[],fileName:"tableExport",htmlContent:!1,ignoreColumn:[],ignoreRow:[],jsonScope:"all",jspdf:{orientation:"p",unit:"pt",format:"a4",margins:{left:20,right:10,top:10,bottom:10},autotable:{styles:{cellPadding:2,rowHeight:12,fontSize:8,fillColor:255,textColor:50,fontStyle:"normal",overflow:"ellipsize",halign:"left",valign:"middle"},headerStyles:{fillColor:[52,73,94],textColor:255,fontStyle:"bold",halign:"center"},alternateRowStyles:{fillColor:245},tableExport:{onAfterAutotable:null,onBeforeAutotable:null,
onTable:null,outputImages:!0}}},numbers:{html:{decimalMark:".",thousandsSeparator:","},output:{decimalMark:".",thousandsSeparator:","}},onCellData:null,onCellHtmlData:null,outputMode:"file",pdfmake:{enabled:!1},tbodySelector:"tr",tfootSelector:"tr",theadSelector:"tr",tableName:"myTableName",type:"csv",worksheetName:"xlsWorksheetName"},r=this,Q=null,p=[],h=[],l=0,A=[],n="",H=[],z;c.extend(!0,a,u);H=S(r);if("csv"==a.type||"tsv"==a.type||"txt"==a.type){var D="",I=0,l=0,U=function(b,k,e){b.each(function(){n=
"";y(this,k,l,e+b.length,function(b,c,e){var d=n,g="";if(null!==b)if(b=x(b,c,e),c=null===b||""===b?"":b.toString(),"tsv"==a.type)b instanceof Date&&b.toLocaleString(),g=P(c,"\t"," ");else if(b instanceof Date)g=a.csvEnclosure+b.toLocaleString()+a.csvEnclosure;else if(g=P(c,a.csvEnclosure,a.csvEnclosure+a.csvEnclosure),0<=g.indexOf(a.csvSeparator)||/[\r\n ]/g.test(g))g=a.csvEnclosure+g+a.csvEnclosure;n=d+(g+("tsv"==a.type?"\t":a.csvSeparator))});n=c.trim(n).substring(0,n.length-1);0<n.length&&(0<D.length&&
(D+="\n"),D+=n);l++});return b.length},I=I+U(c(r).find("thead").first().find(a.theadSelector),"th,td",I);c(r).find("tbody").each(function(){I+=U(c(this).find(a.tbodySelector),"td,th",I)});a.tfootSelector.length&&U(c(r).find("tfoot").first().find(a.tfootSelector),"td,th",I);D+="\n";!0===a.consoleLog&&console.log(D);if("string"===a.outputMode)return D;if("base64"===a.outputMode)return F(D);if("window"===a.outputMode){C(!1,"data:text/"+("csv"==a.type?"csv":"plain")+";charset=utf-8,",D);return}try{z=
new Blob([D],{type:"text/"+("csv"==a.type?"csv":"plain")+";charset=utf-8"}),saveAs(z,a.fileName+"."+a.type,"csv"!=a.type||!1===a.csvUseBOM)}catch(b){C(a.fileName+"."+a.type,"data:text/"+("csv"==a.type?"csv":"plain")+";charset=utf-8,"+("csv"==a.type&&a.csvUseBOM?"\ufeff":""),D)}}else if("sql"==a.type){var l=0,v="INSERT INTO `"+a.tableName+"` (",p=c(r).find("thead").first().find(a.theadSelector);p.each(function(){y(this,"th,td",l,p.length,function(a,c,e){v+="'"+x(a,c,e)+"',"});l++;v=c.trim(v);v=c.trim(v).substring(0,
v.length-1)});v+=") VALUES ";c(r).find("tbody").each(function(){h.push.apply(h,c(this).find(a.tbodySelector))});a.tfootSelector.length&&h.push.apply(h,c(r).find("tfoot").find(a.tfootSelector));c(h).each(function(){n="";y(this,"td,th",l,p.length+h.length,function(a,c,e){n+="'"+x(a,c,e)+"',"});3<n.length&&(v+="("+n,v=c.trim(v).substring(0,v.length-1),v+="),");l++});v=c.trim(v).substring(0,v.length-1);v+=";";!0===a.consoleLog&&console.log(v);if("string"===a.outputMode)return v;if("base64"===a.outputMode)return F(v);
try{z=new Blob([v],{type:"text/plain;charset=utf-8"}),saveAs(z,a.fileName+".sql")}catch(b){C(a.fileName+".sql","data:application/sql;charset=utf-8,",v)}}else if("json"==a.type){var J=[],p=c(r).find("thead").first().find(a.theadSelector);p.each(function(){var a=[];y(this,"th,td",l,p.length,function(b,c,d){a.push(x(b,c,d))});J.push(a)});var V=[];c(r).find("tbody").each(function(){h.push.apply(h,c(this).find(a.tbodySelector))});a.tfootSelector.length&&h.push.apply(h,c(r).find("tfoot").find(a.tfootSelector));
c(h).each(function(){var a={},k=0;y(this,"td,th",l,p.length+h.length,function(b,c,f){J.length?a[J[J.length-1][k]]=x(b,c,f):a[k]=x(b,c,f);k++});!1===c.isEmptyObject(a)&&V.push(a);l++});u="";u="head"==a.jsonScope?JSON.stringify(J):"data"==a.jsonScope?JSON.stringify(V):JSON.stringify({header:J,data:V});!0===a.consoleLog&&console.log(u);if("string"===a.outputMode)return u;if("base64"===a.outputMode)return F(u);try{z=new Blob([u],{type:"application/json;charset=utf-8"}),saveAs(z,a.fileName+".json")}catch(b){C(a.fileName+
".json","data:application/json;charset=utf-8;base64,",u)}}else if("xml"===a.type){var l=0,B='<?xml version="1.0" encoding="utf-8"?>',B=B+"<tabledata><fields>",p=c(r).find("thead").first().find(a.theadSelector);p.each(function(){y(this,"th,td",l,p.length,function(a,c,e){B+="<field>"+x(a,c,e)+"</field>"});l++});var B=B+"</fields><data>",ha=1;c(r).find("tbody").each(function(){h.push.apply(h,c(this).find(a.tbodySelector))});a.tfootSelector.length&&h.push.apply(h,c(r).find("tfoot").find(a.tfootSelector));
c(h).each(function(){var a=1;n="";y(this,"td,th",l,p.length+h.length,function(b,c,d){n+="<column-"+a+">"+x(b,c,d)+"</column-"+a+">";a++});0<n.length&&"<column-1></column-1>"!=n&&(B+='<row id="'+ha+'">'+n+"</row>",ha++);l++});B+="</data></tabledata>";!0===a.consoleLog&&console.log(B);if("string"===a.outputMode)return B;if("base64"===a.outputMode)return F(B);try{z=new Blob([B],{type:"application/xml;charset=utf-8"}),saveAs(z,a.fileName+".xml")}catch(b){C(a.fileName+".xml","data:application/xml;charset=utf-8;base64,",
B)}}else if("excel"==a.type||"xls"==a.type||"word"==a.type||"doc"==a.type){u="excel"==a.type||"xls"==a.type?"excel":"word";var K="excel"==u?"xls":"doc",q='xmlns:x="urn:schemas-microsoft-com:office:'+u+'"',G="";c(r).filter(function(){return"none"!=c(this).data("tableexport-display")&&(c(this).is(":visible")||"always"==c(this).data("tableexport-display"))}).each(function(){var b=c(this);l=0;H=S(this);G+="<table><thead>";p=b.find("thead").first().find(a.theadSelector);p.each(function(){n="";y(this,"th,td",
l,p.length,function(b,e,d){if(null!==b){var k="";n+="<th";for(var g in a.excelstyles)if(a.excelstyles.hasOwnProperty(g)){var f=c(b).css(a.excelstyles[g]);""!==f&&"0px none rgb(0, 0, 0)"!=f&&"rgba(0, 0, 0, 0)"!=f&&(k+=""===k?'style="':";",k+=a.excelstyles[g]+":"+f)}""!==k&&(n+=" "+k+'"');c(b).is("[colspan]")&&(n+=' colspan="'+c(b).attr("colspan")+'"');c(b).is("[rowspan]")&&(n+=' rowspan="'+c(b).attr("rowspan")+'"');n+=">"+x(b,e,d)+"</th>"}});0<n.length&&(G+="<tr>"+n+"</tr>");l++});G+="</thead><tbody>";
b.find("tbody").each(function(){h.push.apply(h,c(this).find(a.tbodySelector))});a.tfootSelector.length&&h.push.apply(h,b.find("tfoot").find(a.tfootSelector));c(h).each(function(){var b=c(this);n="";y(this,"td,th",l,p.length+h.length,function(e,d,k){if(null!==e){var g="",f=c(e).data("tableexport-msonumberformat");"undefined"==typeof f&&"function"===typeof a.onMsoNumberFormat&&(f=a.onMsoNumberFormat(e,d,k));"undefined"!=typeof f&&""!==f&&(g="style=\"mso-number-format:'"+f+"'");for(var m in a.excelstyles)a.excelstyles.hasOwnProperty(m)&&
(f=c(e).css(a.excelstyles[m]),""===f&&(f=b.css(a.excelstyles[m])),""!==f&&"0px none rgb(0, 0, 0)"!=f&&"rgba(0, 0, 0, 0)"!=f&&(g+=""===g?'style="':";",g+=a.excelstyles[m]+":"+f));n+="<td";""!==g&&(n+=" "+g+'"');c(e).is("[colspan]")&&(n+=' colspan="'+c(e).attr("colspan")+'"');c(e).is("[rowspan]")&&(n+=' rowspan="'+c(e).attr("rowspan")+'"');n+=">"+x(e,d,k).replace(/\n/g,"<br>")+"</td>"}});0<n.length&&(G+="<tr>"+n+"</tr>");l++});a.displayTableName&&(G+="<tr><td></td></tr><tr><td></td></tr><tr><td>"+x(c("<p>"+
a.tableName+"</p>"))+"</td></tr>");G+="</tbody></table>";!0===a.consoleLog&&console.log(G)});q='<html xmlns:o="urn:schemas-microsoft-com:office:office" '+q+' xmlns="http://www.w3.org/TR/REC-html40">'+('<meta http-equiv="content-type" content="application/vnd.ms-'+u+'; charset=UTF-8">')+"<head>";"excel"===u&&(q+="\x3c!--[if gte mso 9]>",q+="<xml>",q+="<x:ExcelWorkbook>",q+="<x:ExcelWorksheets>",q+="<x:ExcelWorksheet>",q+="<x:Name>",q+=a.worksheetName,q+="</x:Name>",q+="<x:WorksheetOptions>",q+="<x:DisplayGridlines/>",
...
"width","mm"),h:O(c(r).first().get(0),"height","mm")},pagesplit:!1};var ia=new jsPDF(a.jspdf.orientation,a.jspdf.unit,a.jspdf.format);ia.addHTML(c(r).first(),a.jspdf.margins.left,a.jspdf.margins.top,u,function(){aa(ia)})}else{var f=a.jspdf.autotable.tableExport;if("string"===typeof a.jspdf.format&&"bestfit"===a.jspdf.format.toLowerCase()){var L={a0:[2383.94,3370.39],a1:[1683.78,2383.94],a2:[1190.55,1683.78],a3:[841.89,1190.55],a4:[595.28,841.89]},R="",M="",ja=0;c(r).filter(":visible").each(function(){if("none"!=
c(this).css("display")){var a=O(c(this).get(0),"width","pt");if(a>ja){a>L.a0[0]&&(R="a0",M="l");for(var f in L)L.hasOwnProperty(f)&&L[f][1]>a&&(R=f,M="l",L[f][0]>a&&(M="p"));ja=a}}});a.jspdf.format=""===R?"a4":R;a.jspdf.orientation=""===M?"w":M}f.doc=new jsPDF(a.jspdf.orientation,a.jspdf.unit,a.jspdf.format);!0===f.outputImages&&(f.images={});"undefined"!=typeof f.images&&(c(r).filter(function(){return"none"!=c(this).data("tableexport-display")&&(c(this).is(":visible")||"always"==c(this).data("tableexport-display"))}).each(function(){var b=
0;p=c(this).find("thead").find(a.theadSelector);c(this).find("tbody").each(function(){h.push.apply(h,c(this).find(a.tbodySelector))});a.tfootSelector.length&&h.push.apply(h,c(this).find("tfoot").find(a.tfootSelector));c(h).each(function(){y(this,"td,th",p.length+b,p.length+h.length,function(a,b,d){"undefined"!==typeof a&&null!==a&&(b=c(a).children(),"undefined"!=typeof b&&0<b.length&&ca(a,b,f))});b++})}),p=[],h=[]);ka(f,function(b){c(r).filter(function(){return"none"!=c(this).data("tableexport-display")&&
