...
a,h);var q=null;if("csv"==a.type||"txt"==a.type){var c="",f=0;d(this).find("thead").find(a.theadSelector).each(function(){c+="\n";d(this).filter(":visible").find("th,td").each(function(b,e){"none"!=d(this).css("display")&&"none"!=d(this).data("tableexport-display")&&-1==a.ignoreColumn.indexOf(b)&&(c+=v(this,f,b)+a.csvSeparator)});f++;c=d.trim(c);c=d.trim(c).substring(0,c.length-1)});d(this).find("tbody").find(a.tbodySelector).each(function(){c+="\n";d(this).filter(":visible").find("td").each(function(b,
...
0,g='<?xml version="1.0" encoding="utf-8"?>',g=g+"<tabledata><fields>";d(this).find("thead").find(a.theadSelector).each(function(){d(this).filter(":visible").find("th,td").each(function(b,c){"none"!=d(this).css("display")&&"none"!=d(this).data("tableexport-display")&&-1==a.ignoreColumn.indexOf(b)&&(g+="<field>"+k(this,f,b)+"</field>")});f++});var g=g+"</fields><data>",r=1;d(this).find("tbody").find(a.tbodySelector).each(function(){g+='<row id="'+r+'">';var b=0;d(this).filter(":visible").find("td").each(function(c,
